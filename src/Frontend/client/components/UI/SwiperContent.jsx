  ...
  return (
    <div className="w-[96%] mx-auto">
      ...
      <Swiper
        ...
        className="w-full mt-10 pt-7"
      >
        {data.map((item, index) => (
          <SwiperSlide key={index}>
            <div className="w-full h-fit flex flex-col items-start justify-start relative pb-5 bg-[#1C232E]">
              <div className="w-[85%] mx-auto z-10">
                <img 
                  src={item.img} 
                  alt="img"
                  className="mx-auto w-full left-0 top-[-20px] px-12 pb-5 object-fill mt-[-20px]"
                />
                  ...
                  {item.spares.map((spare, index) => (
                    <div key={index} className='w-full flex items-center justify-start gap-4 pt-5 h-fit'>
                      ...
                      <p className='flex flex-col gap-2'>
                        ...
                        <span className='text-[#C3CEE1] text-xs'>{spare.name}</span>
                      </p>
                    </div>
                  ))}
                </div>
